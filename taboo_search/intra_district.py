def switch_center(district, distance_matrix, taboo_list):
    ...
    for client_tup in ordered_clients:
        ...
        is_taboo = False
        for taboo_client in taboo_list.list:
            if client_tup[0] == taboo_client.client_id:
                is_taboo = True
                break
